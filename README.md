...
This **s25fl512s** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **S25FL512S** BSP QSPI component part.
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/s25fl512s/blob/main/Release_Notes.html).
...
If you have any issue with the **software content** of this repository, you can file an issue [here](https://github.com/STMicroelectronics/s25fl512s/issues/new/choose).
